...
public final class CipherBox {
    public final int aesKeyLength = ConfigCenter.mp.security.aes_key_length;
    ...
    public RSAPrivateKey getPrivateKey() {
        if (privateKey == null) {
            String key = ConfigCenter.mp.security.private_key;
            try {
    ...
    public RSAPublicKey getPublicKey() {
        if (publicKey == null) {
            String key = ConfigCenter.mp.security.public_key;
            try {
